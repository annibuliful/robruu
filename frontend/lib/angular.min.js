            ...
            function Ta(a, b, d, e, f, g, h, k, l) {
                ...
                for (var p = -Number.MAX_VALUE, v = l.newScopeDirective, q = l.controllerDirectives, s = l.newIsolateScopeDirective,
                    ...
                    if (!Ca && (u.replace && (u.templateUrl || u.template) || u.transclude && !u.$$tlb)) {
                        for (x = A + 1; Ca = a[x++];)
                            if (Ca.transclude && !Ca.$$tlb || Ca.replace &&
        ...
        attr: function(a, b, d) {
            ...
            if (c !== Na && 2 !== c && 8 !== c)
                if (c = M(b), Eb[c])
                    ...
                    else return a[b] || (a.attributes.getNamedItem(b) || A).specified ?
                        c : void 0;
                ...
                return {
                    ...
                    push: function(g, h, k, l) {
                        ...
                        if (k.addClass || k.removeClass)
                            if (h = k.addClass, l = k.removeClass, k = a.get(g) || {}, h = e(k, h, !0), l = e(k, l, !1), h || l) a.put(g,
